...
public class OperatorGUI extends JFrame {
    ...
    private DefaultTableModel mdl_user_list;        //model user list
    ...
    public OperatorGUI (Operator operator)
        {
            ...
            lbl_welcome.setText ("You are Welcome : " + operator.getName ());
        ...
        //Patika List
            ...
            Object[] col_courseList ={"ID","Course Name","Programming Language","Patika","Instructor"};
            ...
            tbl_course_list.getColumnModel ().getColumn (0).setMinWidth (25);
            tbl_course_list.getColumnModel ().getColumn (0).setMinWidth (50);
            ...
            btn_logout.addActionListener (e -> {
                dispose ();         //var olan framei kapatır
